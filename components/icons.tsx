...
export const ChevronDownIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L8 10.0046L12.158 6.13523C12.3595 5.94637 12.6759 5.95657 12.8648 6.15803C13.0536 6.35949 13.0434 6.67591 12.842 6.86477L8.34197 11.0148C8.15402 11.1951 7.84598 11.1951 7.65803 11.0148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z"
      fill="currentColor"
    />
  </svg>
);
...
export const ChevronUpIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M3.13523 9.84197C3.3241 10.0434 3.64052 10.0536 3.84197 9.86477L8 5.99536L12.158 9.86477C12.3595 10.0536 12.6759 10.0434 12.8648 9.84197C13.0536 9.64051 13.0434 9.32409 12.842 9.13523L8.34197 4.98523C8.15402 4.80492 7.84598 4.80492 7.65803 4.98523L3.15803 9.13523C2.95657 9.32409 2.94637 9.64051 3.13523 9.84197Z"
      fill="currentColor"
    />
  </svg>
);
...
export const WarningIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M8 0C3.582 0 0 3.582 0 8C0 12.418 3.582 16 8 16C12.418 16 16 12.418 16 8C16 3.582 12.418 0 8 0ZM8 4.5C8.414 4.5 8.75 4.836 8.75 5.25V8.75C8.75 9.164 8.414 9.5 8 9.5C7.586 9.5 7.25 9.164 7.25 8.75V5.25C7.25 4.836 7.586 4.5 8 4.5ZM8.75 11.75C8.75 12.164 8.414 12.5 8 12.5C7.586 12.5 7.25 12.164 7.25 11.75C7.25 11.336 7.586 11 8 11C8.414 11 8.75 11.336 8.75 11.75Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const IntegrationIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.5 1C5.5 0.447715 5.94772 0 6.5 0H9.5C10.0523 0 10.5 0.447715 10.5 1V2.5H14C15.1046 2.5 16 3.39543 16 4.5V11.5C16 12.6046 15.1046 13.5 14 13.5H10.5V15C10.5 15.5523 10.0523 16 9.5 16H6.5C5.94772 16 5.5 15.5523 5.5 15V13.5H2C0.895431 13.5 0 12.6046 0 11.5V4.5C0 3.39543 0.895431 2.5 2 2.5H5.5V1ZM7 1.5V2.5H9V1.5H7ZM7 13.5V14.5H9V13.5H7ZM2 4H14C14.2761 4 14.5 4.22386 14.5 4.5V11.5C14.5 11.7761 14.2761 12 14 12H2C1.72386 12 1.5 11.7761 1.5 11.5V4.5C1.5 4.22386 1.72386 4 2 4ZM7.5 8C7.5 8.82843 6.82843 9.5 6 9.5C5.17157 9.5 4.5 8.82843 4.5 8C4.5 7.17157 5.17157 6.5 6 6.5C6.82843 6.5 7.5 7.17157 7.5 8ZM10 9.5C10.8284 9.5 11.5 8.82843 11.5 8C11.5 7.17157 10.8284 6.5 10 6.5C9.17157 6.5 8.5 7.17157 8.5 8C8.5 8.82843 9.17157 9.5 10 9.5Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const LightThemeIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M5.64,17l-.71.71a1,1,0,0,0,0,1.41,1,1,0,0,0,1.41,0l.71-.71A1,1,0,0,0,5.64,17ZM5,12a1,1,0,0,0-1-1H3a1,1,0,0,0,0,2H4A1,1,0,0,0,5,12Zm7-7a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4A1,1,0,0,0,12,5ZM5.64,7.05a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29,1,1,0,0,0,0-1.41l-.71-.71A1,1,0,0,0,4.93,6.34Zm12,.29a1,1,0,0,0,.7-.29l.71-.71a1,1,0,1,0-1.41-1.41L17,5.64a1,1,0,0,0,0,1.41A1,1,0,0,0,17.66,7.34ZM21,11H20a1,1,0,0,0,0,2h1a1,1,0,0,0,0-2Zm-9,8a1,1,0,0,0-1,1v1a1,1,0,0,0,2,0V20A1,1,0,0,0,12,19ZM18.36,17A1,1,0,0,0,17,18.36l.71.71a1,1,0,0,0,1.41,0,1,1,0,0,0,0-1.41ZM12,6.5A5.5,5.5,0,1,0,17.5,12,5.51,5.51,0,0,0,12,6.5Zm0,9A3.5,3.5,0,1,1,15.5,12,3.5,3.5,0,0,1,12,15.5Z"/></svg>
  );
};

export const DarkThemeIcon = ({ size = 16 }: { size?: number }) => {
  return (
<svg width="32px" height="32px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
  <g id="Lager_94" data-name="Lager 94" transform="translate(0)">
    <path id="Path_70" data-name="Path 70" d="M12.516,4.509A12,12,0,0,0,22.3,19.881,12.317,12.317,0,0,0,24,20a11.984,11.984,0,0,0,3.49-.514,12.1,12.1,0,0,1-9.963,8.421A12.679,12.679,0,0,1,16,28,12,12,0,0,1,12.516,4.509M16,0a16.5,16.5,0,0,0-2.212.15A16,16,0,0,0,16,32a16.526,16.526,0,0,0,2.01-.123A16.04,16.04,0,0,0,31.85,18.212,16.516,16.516,0,0,0,32,15.944,1.957,1.957,0,0,0,30,14a2.046,2.046,0,0,0-1.23.413A7.942,7.942,0,0,1,24,16a8.35,8.35,0,0,1-1.15-.08,7.995,7.995,0,0,1-5.264-12.7A2.064,2.064,0,0,0,16.056,0Z" fill="#eeeeee"/>
  </g>
</svg>
...
export const SignoutIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M21.593 10.943c.584.585.584 1.53 0 2.116L18.71 15.95c-.39.39-1.03.39-1.42 0a.996.996 0 0 1 0-1.41 9.552 9.552 0 0 1 1.689-1.345l.387-.242-.207-.206a10 10 0 0 1-2.24.254H8.998a1 1 0 1 1 0-2h7.921a10 10 0 0 1 2.24.254l.207-.206-.386-.241a9.562 9.562 0 0 1-1.69-1.348.996.996 0 0 1 0-1.41c.39-.39 1.03-.39 1.42 0l2.883 2.893zM14 16a1 1 0 0 0-1 1v1.5a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v1.505a1 1 0 1 0 2 0V5.5A2.5 2.5 0 0 0 12.5 3h-7A2.5 2.5 0 0 0 3 5.5v13A2.5 2.5 0 0 0 5.5 21h7a2.5 2.5 0 0 0 2.5-2.5V17a1 1 0 0 0-1-1z" fill="currentColor"/></svg>
  );
};